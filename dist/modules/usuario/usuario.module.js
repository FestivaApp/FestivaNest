...
const tipo_user_entity_1 = require("./entities/tipo-user.entity");
...
exports.UsuarioModule = UsuarioModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([tipo_user_entity_1.TipoUser, usuario_entity_1.Usuario])],
